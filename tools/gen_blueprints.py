...
<meta property="og:title" content="블루프린트 부품 카탈로그 (한국어) — 샌드: 레이더스 오브 소피">
<meta property="og:description" content="트램플러 부품을 대분류·세부 태그로 필터링하고 스탯·비교를 한국어로.">
<meta property="og:image" content="https://showneykim.github.io/sand-kr-guide/assets/img/bp_editor.webp">
