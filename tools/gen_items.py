...
<div class="topbar"><div class="in">
  ...
  <nav class="tabs" aria-label="주요"><a href="index.html">입문 가이드</a><a href="tech.html">테크트리</a><a class="on" aria-current="page" href="items.html">아이템 도감</a><a href="blueprints.html">블루프린트</a><a href="reference.html">수치</a></nav>
</div></div>
